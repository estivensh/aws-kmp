...
expect class AWSS3 private constructor(
     ...
     * attached policy, as described in [this blog post](https://aws.amazon.com/
     * articles/1434?_encoding=UTF8&queryArg=searchQuery&x=0&fromSearch=1&y=0&searchPath=all).
     * That method is only suitable for POSTs from HTML
     * forms by browsers.
     *
     *
     *
